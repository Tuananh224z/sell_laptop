      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Quản lý thông tin liên hệ, mạng xã hội và chính sách cửa hàng
          </p>
        </div>
        <button
          onClick={handleSave}
            ...
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-2xl px-4 py-2.5 text-sm font-medium focus:ring-2 focus:ring-primary-500/10 outline-none"
                />
              </div>
              <div>
                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 block">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-2xl pl-10 pr-4 py-2.5 text-sm font-medium focus:ring-2 focus:ring-primary-500/10 outline-none"
                  />
                </div>
              </div>
              <div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  <p className="text-xs text-gray-500 leading-relaxed mt-6 italic">
                    * Khuyên dùng: Ảnh trong suốt (PNG), kích thước 300x100px.
                    Logo sẽ hiển thị trên Header và Footer của Website.
                  </p>
                </div>
              </div>
                ...
                {[
                  ...
                  <div key={b.id}>
                    ...
                    <div className="aspect-[2/1] bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden relative group">
                      {files[b.id] ? (
                        <img
                          src={URL.createObjectURL(files[b.id])}
                          className="w-full h-full object-cover"
                          alt="Preview"
                        />
                      ) : (form as any)[b.id] ? (
                        <img
                          src={`${BACKEND}${(form as any)[b.id]}`}
                          className="w-full h-full object-cover"
                          alt={b.id}
                        />
                      ) : (
                    ...
                    <p className="text-[10px] text-gray-400 mt-2 text-center">
                      Kích thước khuyên dùng: {b.desc}
                    </p>
                    <div className="mt-3 space-y-2">
                      <input
                        value={(form as any)[`${b.id}Title`]}
                        onChange={(e) =>
                          setForm({ ...form, [`${b.id}Title`]: e.target.value })
                        }
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setForm({ ...form, [`${b.id}Sub`]: e.target.value })
                        }
        ...
        <div className="space-y-6">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-2xl px-4 py-2.5 text-sm font-bold text-primary-600 focus:ring-2 focus:ring-primary-500/10 outline-none"
                />
              </div>
              <div>
                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 block">
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-2xl px-4 py-2.5 text-sm font-bold text-green-600 focus:ring-2 focus:ring-primary-500/10 outline-none"
                />
                <p className="text-[10px] text-gray-400 mt-2 font-medium">
                  Đơn hàng trên mức này sẽ được FreeShip
                </p>
              </div>
              <div className="pt-4 border-t border-gray-50">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-2xl px-4 py-2.5 text-sm font-bold text-red-600 focus:ring-2 focus:ring-primary-500/10 outline-none"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="bg-primary-600 rounded-3xl p-6 text-white shadow-xl shadow-primary-100">
            ...
            <p className="text-primary-100 text-xs leading-relaxed">
              Các thông tin này sẽ được hiển thị công khai ở chân trang
              (Footer), trang liên hệ và trong quá trình thanh toán (Checkout)
              của khách hàng. Hãy đảm bảo thông tin luôn chính xác.
            </p>
          </div>
        </div>
      </div>
