    ...
    <div className="p-6 space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              {loading ? (
                ...
                products.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3 text-center">
                      <span
                        className={`font-bold text-sm ${p.stock === 0 ? "text-red-500" : p.stock < 5 ? "text-yellow-600" : "text-gray-800"}`}
                      >
                        {p.stock}
                      </span>
                    </td>
                    <td className="px-5 py-3 text-center">
                      <span
                        className={`text-xs font-semibold px-2.5 py-1 rounded-full ${statusColor(p)}`}
                      >
                        {statusLabel(p)}
                      </span>
                    </td>
        ...
        <div className="px-5 py-4 border-t border-gray-100 flex items-center justify-between text-sm text-gray-500">
          <span>
            Hiển thị {total === 0 ? 0 : from}–{to} / {total}
          </span>
