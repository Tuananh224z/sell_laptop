                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-0.5">
                        <span className="font-bold text-gray-900 text-sm truncate">
                          {
                            c.participants.find((p) => p._id !== admin?.id)
                              ?.name
                          }
                        </span>
                      ...
                      <p
                        className={`text-xs truncate ${unreadCount > 0 ? "text-gray-900 font-bold" : "text-gray-500"}`}
                      >
            ...
            <>
              ...
              <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/10">
                <div className="flex items-center gap-3">
                  <div className="relative">
                    {detail.participants.find((p) => p._id !== admin?.id)
                      ?.avatar ? (
                      <img
                        src={`${BACKEND}${detail.participants.find((p) => p._id !== admin?.id)?.avatar}`}
              ...
              >
                {detail.messages.map((m, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`max-w-[70%] rounded-2xl px-5 py-3.5 shadow-sm ${isMe ? "bg-primary-600 text-white rounded-tr-sm shadow-primary-50" : "bg-white border border-gray-100 text-gray-900 rounded-tl-sm"}`}
                      >
                        {m.mediaUrl && (
                        ...
                        <p
                          className={`text-[9px] mt-2 font-bold uppercase tracking-wider ${isMe ? "text-primary-200" : "text-gray-400"}`}
                        >
