...
const recentOrders = [
  ...
  },
  {
    id: "#ORD-002",
    customer: "Trần Thị B",
    product: "Chuột Logitech G Pro X2",
    total: "2,790,000₫",
    status: "Hoàn thành",
  ...
  <div className="p-6 space-y-6">
    <div>
      ...
      <p className="text-sm text-gray-500 mt-0.5">
        Chào mừng trở lại! Đây là tóm tắt hoạt động hôm nay.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      {stats.map((s) => (
        ...
        >
          <div
            className={`w-11 h-11 ${s.color} rounded-xl flex items-center justify-center shrink-0`}
          >
          ...
          <div className="min-w-0">
            ...
            <p
              className={`text-xs font-semibold mt-0.5 flex items-center gap-0.5 ${s.up ? "text-green-600" : "text-red-500"}`}
            >
            ...
            <tbody className="divide-y divide-gray-50">
              {recentOrders.map((o) => (
                <tr key={o.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-3 text-gray-600 hidden md:table-cell max-w-[180px] truncate">
                    {o.product}
                  </td>
                  ...
                  <td className="px-6 py-3">
                    <span
                      className={`text-xs font-semibold px-2.5 py-1 rounded-full ${o.statusColor}`}
                    >
                      {o.status}
                    </span>
                  </td>
