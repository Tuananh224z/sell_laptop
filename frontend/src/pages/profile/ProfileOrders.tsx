        ...
        <div className="space-y-4">
            ...
            return (
              ...
              >
                ...
                <div className="bg-gray-50/50 px-4 py-3 border-b border-gray-100 flex items-center justify-between flex-wrap gap-2">
                  ...
                  <div
                    className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-xs font-semibold ${status.color}`}
                  >
                ...
                <div className="bg-gray-50/30 px-4 py-3 border-t border-gray-100 flex items-center justify-between flex-wrap gap-4">
                  <div className="text-sm">
                    ...
                    <span className="ml-2 font-bold text-primary-600 text-base">
          ...
          {filteredOrders.length === 0 && (
            <div className="text-center py-20 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
              ...
              <Link
                to="/products"
                className="mt-4 inline-block text-sm text-primary-600 font-bold hover:underline"
              >
                Tiếp tục mua sắm
              </Link>
            </div>
